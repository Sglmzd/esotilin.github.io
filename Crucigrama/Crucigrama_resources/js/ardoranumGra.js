...
if ($(".sol").length !=0) {var color1="#FFFFFF";var color2=colorBack;
$(".sol").css("background","-webkit-gradient(linear, left top, left bottom, from("+color1+"), to("+color2+"))");
$(".sol").css("background","-webkit-linear-gradient("+color1+", "+color2+")");
$(".sol").css("background","-moz-linear-gradient(top, "+color1+", "+color2+")");
$(".sol").css("background","-ms-linear-gradient("+color1+", "+color2+")");
$(".sol").css("background","-o-linear-gradient("+color1+", "+color2+")");
$(".sol").css("background","linear-gradient("+color1+", "+color2+")");
$(".sol").css("filter","progid:DXImageTransform.Microsoft.Alpha(startColorstr='"+color1+"', endColorstr='"+color2+"')");}
